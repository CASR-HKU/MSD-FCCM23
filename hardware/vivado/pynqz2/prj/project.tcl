...
#
# project.tcl: Tcl script for re-creating project 'msd_hw_pynq'
#
# Generated by Vivado on Sat Apr 08 21:40:21 HKT 2023
...
set _xil_proj_name_ "msd_hw_pynq"
...
# Create 'sys_top_sim' fileset (if not found)
if {[string equal [get_filesets -quiet sys_top_sim] ""]} {
  create_fileset -simset sys_top_sim
}

# Set 'sys_top_sim' fileset object
set obj [get_filesets sys_top_sim]
set files [list \
 [file normalize "${origin_dir}/../tb/tb_itf.sv"] \
 [file normalize "${origin_dir}/../tb/tb_drv.sv"] \
 [file normalize "${origin_dir}/../tb/tb_drv_axis.sv"] \
...
# Set 'sys_top_sim' fileset file properties for remote files
set file "$origin_dir/../tb/tb_itf.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sys_top_sim] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
# Set 'sys_top_sim' fileset file properties for local files
# None

# Set 'sys_top_sim' fileset properties
set obj [get_filesets sys_top_sim]
...
set_property -name "name" -value "sys_top_sim" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/msd_hw_pynq.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/msd_hw_pynq.srcs/utils_1/imports/impl_1" -objects $obj
