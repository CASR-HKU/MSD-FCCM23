proc getPresetInfo {} {
  return [dict create name {ultra96_presets} description {ultra96_presets}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 display_name {ultra96_presets} ]
}
