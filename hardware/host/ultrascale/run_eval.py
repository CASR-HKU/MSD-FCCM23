...
model_sel = ["vgg16", "resnet18", "resnet50", "mobilenetv2"]
# model dict: [layer number, GMACs]
model_dict = {"vgg16": [16, 15.5], "resnet18": [21, 1.82], "resnet50": [54, 4.12], "mobilenetv2": [53, 0.319]}
hw_utl = [52.64, 264] # [kLUT, DSP]

parser = argparse.ArgumentParser()
parser.add_argument("-m", "--model", type=str, default='resnet18')
dnn_model = parser.parse_args().model
model_csv = "ultra96_" + dnn_model + ".csv"

assert dnn_model in model_sel, "Not support this model in Ultra96!"

print("Start latency evaluation")
print("------------------------")
print("Device: Ultra96 (ZU3EG)")
...
for test_idx in range(10):
    # load bitstream
    overlay = pynq.Overlay('/home/xilinx/jupyter_notebooks/MSD_FCCM_2023/msd_hw_ults.bit')
    overlay.download()
    freq = pynq.ps.Clocks.fclk0_mhz
    ...
    # get data
    latency_ms = ac.report_latency(freq)
